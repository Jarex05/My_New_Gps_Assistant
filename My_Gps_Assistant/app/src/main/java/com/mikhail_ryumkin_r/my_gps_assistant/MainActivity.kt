...
import com.mikhail_ryumkin_r.my_gps_assistant.fragments.NeutralInsertChetFragment
import com.mikhail_ryumkin_r.my_gps_assistant.fragments.NeutralInsertNechetFragment
    ...
    private fun showBottomDialog() {
        ...
        if (v != 0) {
            ...
            neutralInsertNechetLayout.setOnClickListener {
                dialog.dismiss()
                openFragment(NeutralInsertNechetFragment.newInstance())
            }
            ...
            neutralInsertChetLayout.setOnClickListener {
                dialog.dismiss()
                openFragment(NeutralInsertChetFragment.newInstance())
            }
